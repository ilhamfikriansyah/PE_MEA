...
fig_bar_s_true = px.bar(tes4, x="Total", y='user_id', text_auto='.2s', color = 'type_validation', barmode = 'group',
                    labels={
                        "user_id": "User",
                    },
                    title="Top User")
...
tes4 = pd.crosstab(index=[val_s['user_id'], val_s['type_object'] ],
        columns='Total',
        values=val_s['user_id'],
        aggfunc='count').sort_values(by='Total', ascending=False)
...
fig_bar_s_false = px.bar(tes4, x="Total", y='user_id', text_auto='.2s', color ='type_object', barmode = 'group',
                    labels={
                        "user_id": "User",
                    },
                    title="Top User")
